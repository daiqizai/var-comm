...
SELF_PACKAGES = {"var_comm", "cadsd_jscc", "latent_enhancement", "latent_enhancement_b", "latent_enhancement_eval", "latent_followup", "latent_mechanisms", "latent_enhancement_timing", "wetok_comm", "joint_sender", "latent_research", "short_prefix"}
