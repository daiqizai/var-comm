...
def main():
    ...
    modules.extend(['token_efficiency.budget_lifecycle', 'token_efficiency.budget_extension', 'token_efficiency.evaluation_io', 'token_efficiency.digital_grid', 'token_efficiency.continuous_grid', 'token_efficiency.resource_report', 'token_efficiency.delivery_chain', 'token_efficiency.C_lifecycle', 'token_efficiency.C_train', 'token_efficiency.C_evaluate', 'token_efficiency.C_qualify', 'token_efficiency.C_cache', 'token_efficiency.C_first_matrix', 'token_efficiency.C_followups', 'token_efficiency.C_report'])
